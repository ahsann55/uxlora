...
export default function KitPage({
  ...
  async function handleExport(type: "png" | "uxml" | "figma" | "all") {
    ...
    try {
      ...
      // Auto download
      if (data.urls.png_zip) {
        window.open(data.urls.png_zip, "_blank");
      }
        ...
        {isGenerating && (
          <div className="card text-center py-12">
            <div className="w-16 h-16 bg-brand-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-brand-400 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor">
