  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          required: true,
          placeholder: "e.g. Tower Defense, Battle Royale",
          hint: "Describe your game genre",
        },
        {
          id: "platform",
          label: "Platform",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: "custom_visual_style",
          label: "Custom Art Style",
          type: "text",
          required: true,
          placeholder: "e.g. Watercolor, Low Poly, Voxel",
        ...
        },
    {
        ...
        },
        {
          ...
          type: "text",
          required: false,
          placeholder: "e.g. Handwritten, Retro, Grunge",
          hint: "Describe your preferred typography style",
        },
        {
          id: "orientation",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: "custom_currencies",
          label: "Custom Currencies",
          type: "text",
          required: false,
          placeholder: "e.g. Diamonds, Crystals, Reputation Points",
          hint: "Add any currencies not listed above, comma separated",
        },
        {
          id: "monetization",
        ...
        {
          id: "custom_monetization",
          label: "Custom Monetization",
          type: "text",
          required: false,
          placeholder: "e.g. Season Pass, Loot Boxes, NFTs",
          hint: "Add any monetization not listed above, comma separated",
        },
        {
          id: "game_systems",
          label: "Game Systems",
        ...
        {
          id: "custom_game_systems",
          label: "Custom Game Systems",
          type: "text",
          required: false,
          placeholder: "e.g. Trading System, Alliance Wars, Tournaments",
          hint: "Add any systems not listed above, comma separated",
        },
        {
          id: "home_focus_element",
          label: "Key Focus Element on Home Screen",
          type: "select",
          required: false,
          options: [
            "Main Character / Hero",
            ...
            "Weapon / Equipment Showcase",
            "Pet / Companion",
            "Base / Castle / HQ",
            "Energy / Resource Display",
            "Other",
          ],
          default: "Main Character / Hero",
          hint: "The main visual element featured on your home/main menu screen.",
        },
        {
          id: "custom_home_focus",
          label: "Custom Home Focus Element",
          type: "text",
          required: false,
          placeholder: "e.g. Vehicle, Spaceship, Avatar",
          hint: "Describe the key element on your home screen",
        },
      ],
    },
    {
  ...
  sections: [
    {
      ...
      fields: [
        ...
        {
          id: "custom_genre",
          label: "Custom App Category",
          type: "text",
          required: true,
          placeholder: "e.g. Pet Care, Mental Wellness",
          hint: "Describe your app category",
        },
        {
          id: "platform",
          label: "Platform",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          required: true,
          placeholder: "e.g. Neumorphism, Retro, Brutalist",
        ...
        },
        {
          ...
          type: "text",
          required: false,
          placeholder: "e.g. Playful, Condensed, Display",
          hint: "Describe your preferred typography style",
        },
        {
          id: "screen_resolution",
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          required: true,
          placeholder: "e.g. Community Forum, Booking Platform",
          hint: "Describe your product type",
        },
        {
          id: "target_audience",
          label: "Target Audience",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          required: false,
          placeholder: "e.g. Editorial, Technical, Humanist",
          hint: "Describe your preferred typography style",
        },
        {
          id: "screen_resolution",
